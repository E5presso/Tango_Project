namespace HMI
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.Sensor1BendingStatus.Width = 85;
			// 
			// Sensor1X1Before
			// 
			...
			this.Sensor2BendingStatus.Width = 85;
			// 
			// Sensor2X1Before
			// 
			...
			chartArea11.AxisY.Maximum = 5D;
			chartArea11.AxisY.Minimum = -5D;
			chartArea11.Name = "Sensor1";
			chartArea11.Position.Auto = false;
			chartArea11.Position.Height = 33F;
			chartArea11.Position.Width = 85F;
			chartArea11.Position.X = 2.5F;
			...
			chartArea12.Name = "Sensor2";
			chartArea12.Position.Auto = false;
			chartArea12.Position.Height = 33F;
			chartArea12.Position.Width = 85F;
			chartArea12.Position.X = 2.5F;
			chartArea12.Position.Y = 36F;
			chartArea13.AxisX.Enabled = System.Windows.Forms.DataVisualization.Charting.AxisEnabled.False;
			chartArea13.Name = "Delta";
			chartArea13.Position.Auto = false;
			chartArea13.Position.Height = 31F;
			chartArea13.Position.Width = 85F;
			chartArea13.Position.X = 2.5F;
			chartArea13.Position.Y = 69F;
			this.SensorChart.ChartAreas.Add(chartArea11);
			this.SensorChart.ChartAreas.Add(chartArea12);
			this.SensorChart.ChartAreas.Add(chartArea13);
			this.SensorChart.Dock = System.Windows.Forms.DockStyle.Fill;
			this.SensorChart.Enabled = false;
			legend13.DockedToChartArea = "Sensor1";
			legend13.IsDockedInsideChartArea = false;
			legend13.Name = "Sensor1";
			legend13.Title = "Sensor 1";
			legend14.DockedToChartArea = "Sensor2";
			legend14.IsDockedInsideChartArea = false;
			legend14.Name = "Sensor2";
			legend14.Title = "Sensor 2";
			legend15.DockedToChartArea = "Delta";
			legend15.IsDockedInsideChartArea = false;
			legend15.Name = "Delta";
			legend15.Title = "Delta";
			legend16.Enabled = false;
			legend16.Name = "Hidden";
			this.SensorChart.Legends.Add(legend13);
			this.SensorChart.Legends.Add(legend14);
			this.SensorChart.Legends.Add(legend15);
			this.SensorChart.Legends.Add(legend16);
			...
			series37.ChartArea = "Sensor1";
			series37.ChartType = System.Windows.Forms.DataVisualization.Charting.SeriesChartType.FastLine;
			series37.Color = System.Drawing.Color.SeaGreen;
			series37.Legend = "Sensor1";
			series37.LegendText = "Before";
			series37.Name = "Sensor1Before";
			series38.BorderWidth = 2;
			series38.ChartArea = "Sensor1";
			series38.ChartType = System.Windows.Forms.DataVisualization.Charting.SeriesChartType.FastLine;
			series38.Color = System.Drawing.Color.Orange;
			series38.Legend = "Sensor1";
			series38.LegendText = "After";
			series38.Name = "Sensor1After";
			series39.BorderWidth = 3;
			series39.ChartArea = "Sensor1";
			...
			series39.Legend = "Hidden";
			series39.Name = "Sensor1MaxPlus";
			series40.BorderWidth = 3;
			series40.ChartArea = "Sensor1";
			...
			series40.Legend = "Hidden";
			series40.Name = "Sensor1MaxMinus";
			series41.BorderWidth = 3;
			series41.ChartArea = "Sensor1";
			series41.ChartType = System.Windows.Forms.DataVisualization.Charting.SeriesChartType.FastLine;
			series41.Color = System.Drawing.Color.RoyalBlue;
			series41.Legend = "Hidden";
			series41.Name = "Sensor1MinPlus";
			series42.BorderWidth = 3;
			series42.ChartArea = "Sensor1";
			...
			series42.Legend = "Hidden";
			series42.Name = "Sensor1MinMinus";
			series43.BorderWidth = 2;
			series43.ChartArea = "Sensor2";
			...
			series43.Legend = "Sensor2";
			series43.LegendText = "Before";
			series43.Name = "Sensor2Before";
			series44.BorderWidth = 2;
			series44.ChartArea = "Sensor2";
			...
			series44.Legend = "Sensor2";
			series44.LegendText = "After";
			series44.Name = "Sensor2After";
			series45.BorderWidth = 3;
			series45.ChartArea = "Sensor2";
			...
			series45.Name = "Sensor2MaxPlus";
			series46.BorderWidth = 3;
			series46.ChartArea = "Sensor2";
			...
			series46.Name = "Sensor2MaxMinus";
			series47.BorderWidth = 3;
			series47.ChartArea = "Sensor2";
			...
			series47.Name = "Sensor2MinPlus";
			series48.BorderWidth = 3;
			series48.ChartArea = "Sensor2";
			...
			series48.Name = "Sensor2MinMinus";
			series49.ChartArea = "Delta";
			series49.Color = System.Drawing.Color.RoyalBlue;
			series49.Legend = "Delta";
			series49.LegendText = "Sensor1";
			series49.Name = "Sensor1Delta";
			series50.ChartArea = "Delta";
			series50.Color = System.Drawing.Color.Orange;
			series50.Legend = "Delta";
			series50.LegendText = "Sensor2";
			series50.Name = "Sensor2Delta";
			this.SensorChart.Series.Add(series37);
			this.SensorChart.Series.Add(series38);
			this.SensorChart.Series.Add(series39);
			this.SensorChart.Series.Add(series40);
			this.SensorChart.Series.Add(series41);
			this.SensorChart.Series.Add(series42);
			...
			// Stats2
			// 
			chartArea14.AlignmentOrientation = System.Windows.Forms.DataVisualization.Charting.AreaAlignmentOrientations.None;
			chartArea14.Name = "StatsArea";
			this.Stats2.ChartAreas.Add(chartArea14);
			...
			series51.ChartArea = "StatsArea";
			series51.Color = System.Drawing.Color.SteelBlue;
			series51.Legend = "StatsLegend";
			series51.LegendText = "1st Bending";
			series51.Name = "FirstBended";
			series52.ChartArea = "StatsArea";
			series52.Color = System.Drawing.Color.CornflowerBlue;
			series52.Legend = "StatsLegend";
			series52.LegendText = "2nd Bending";
			series52.Name = "SecondBended";
			this.Stats2.Series.Add(series51);
			this.Stats2.Series.Add(series52);
			...
			// Stats1
			// 
			chartArea15.AlignmentOrientation = System.Windows.Forms.DataVisualization.Charting.AreaAlignmentOrientations.None;
			chartArea15.Name = "StatsArea";
			this.Stats1.ChartAreas.Add(chartArea15);
			...
			series53.ChartArea = "StatsArea";
			series53.Color = System.Drawing.Color.OrangeRed;
			series53.Legend = "StatsLegend";
			series53.LegendText = "Failed";
			series53.Name = "Failed";
			series54.ChartArea = "StatsArea";
			series54.Color = System.Drawing.Color.RoyalBlue;
			series54.Legend = "StatsLegend";
			series54.LegendText = "Passed";
			series54.Name = "Passed";
			this.Stats1.Series.Add(series53);
			this.Stats1.Series.Add(series54);
